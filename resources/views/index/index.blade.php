...
<div class="w3ls-about" id="about">
    <div class="container w3about">
        ...
        <div class="about-img">
            <img src="{{asset('/images/banner3.jpg')}}" class="img-responsive" alt="about image" />
        </div>
    </div>
</div>
<!-- //About Section -->
        ...
        <div class="w3l_team_grids">
            <div class="col-md-3 col-sm-6 col-xs-6 w3l_team_grid">
                <div class="view view-second">
                    <img src="{{asset('/images/t6.jpg')}}" alt=" " class="img-responsive" />
                    <div class="mask"></div>
                    <div class="content">
            ...
            <div class="col-md-3 col-sm-6 col-xs-6 w3l_team_grid">
                <div class="view view-second">
                    <img src="{{asset('/images/t5.jpg')}}" alt=" " class="img-responsive" />
                    <div class="mask"></div>
                    <div class="content">
                        <div class="w3l_social_icons w3l_social_icons1">
                            <ul>
    ...
    <div class="container service">
        ...
        <div class="col-md-6 col-sm-6 service1">
            <div class="col-md-8 col-sm-10 txt-align">
                <h4>computer lab</h4>
                <p>Lorem ipsum is simply dummy text of the printing and typesetting industry. Lorem ip sum has been the industry's standard text ever.</p>
            </div>
    ...
    <div class="container">
        <div class="gallery-grids">
            <div class="col-md-4 col-sm-4 gallery-grid">
                <div class="grid">
                    <figure class="effect-apollo">
                        <a class="example-image-link" href="{{asset('/images/1.jpg')}}" data-lightbox="example-set" data-title="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis ut sem ac lectus mattis sagittis. Donec pulvinar quam sit amet est vestibulum volutpat. Phasellus sed nibh odio. Phasellus posuere at purus sit amet porttitor. Cras euismod egestas enim eget molestie. Aenean ornare condimentum odio, in lacinia felis finibus non. Nam faucibus libero et lectus finibus, sed porttitor velit pellentesque.">
            ...
            <div class="col-md-4 col-sm-4 gallery-grid">
                <div class="grid">
                    <figure class="effect-apollo">
                        <a class="example-image-link" href="{{asset('/images/3.jpg')}}" data-lightbox="example-set" data-title="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis ut sem ac lectus mattis sagittis. Donec pulvinar quam sit amet est vestibulum volutpat. Phasellus sed nibh odio. Phasellus posuere at purus sit amet porttitor. Cras euismod egestas enim eget molestie. Aenean ornare condimentum odio, in lacinia felis finibus non. Nam faucibus libero et lectus finibus, sed porttitor velit pellentesque.">
            ...
            <div class="col-md-4 col-sm-4 gallery-grid">
                <div class="grid">
                    <figure class="effect-apollo">
                        <a class="example-image-link" href="{{asset('/images/6.jpg')}}" data-lightbox="example-set" data-title="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis ut sem ac lectus mattis sagittis. Donec pulvinar quam sit amet est vestibulum volutpat. Phasellus sed nibh odio. Phasellus posuere at purus sit amet porttitor. Cras euismod egestas enim eget molestie. Aenean ornare condimentum odio, in lacinia felis finibus non. Nam faucibus libero et lectus finibus, sed porttitor velit pellentesque.">
            ...
            <div class="col-md-4 col-sm-4 gallery-grid">
                <div class="grid">
                    <figure class="effect-apollo">
                        <a class="example-image-link" href="{{asset('/images/8.jpg')}}" data-lightbox="example-set" data-title="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis ut sem ac lectus mattis sagittis. Donec pulvinar quam sit amet est vestibulum volutpat. Phasellus sed nibh odio. Phasellus posuere at purus sit amet porttitor. Cras euismod egestas enim eget molestie. Aenean ornare condimentum odio, in lacinia felis finibus non. Nam faucibus libero et lectus finibus, sed porttitor velit pellentesque.">
...
<div class="wthree-blog" id="blog">
    ...
    <div class="blog1">
        <div class="blog-box">
            <a href="#" data-toggle="modal" data-target="#myModal1"><img src="{{asset('/images/b1.jpg')}}" alt="blog image" class="img-responsive" /></a>
            <div class="blog-txt">
                ...
                <a href="#" data-toggle="modal" data-target="#myModal1">Know More &raquo; </a>
                <!-- Modal -->
        ...
        <div class="blog-box order">
            <a href="#" data-toggle="modal" data-target="#myModal2"><img src="{{asset('/images/b2.jpg')}}" alt="blog image" class="img-responsive" />
                <div class="blog-txt">
                    <h3><a href="#" data-toggle="modal" data-target="#myModal2">Lorem Ipsum </a></h3>
                    <p>Lorem ipsum is simply dummy text of the printing and typesetting industry. Lorem ip sum has been the industry's standard text ever.
                        Lorem ipsum is simply dummy text.</p>
                    <!-- Trigger the modal with a button -->
                    <a href="#" data-toggle="modal" data-target="#myModal2">Know More &raquo; </a>
                    <!-- Modal -->
                    <!-- bootstrap-pop-up -->
    ...
    <div class="blog2">
        <div class="blog-box">
            <div class="blog-txt order1">
                <h3><a href="#" data-toggle="modal" data-target="#myModal3">Lorem Ipsum </a></h3>
                <p>Lorem ipsum is simply dummy text of the printing and typesetting industry. Lorem ip sum has been the industry's standard text ever.
                    Lorem ipsum is simply dummy text.</p>
                <!-- Trigger the modal with a button -->
                <a href="#" data-toggle="modal" data-target="#myModal3">Know More &raquo; </a>
                <!-- Modal -->
                <!-- bootstrap-pop-up -->
            ...
            <a href="#" data-toggle="modal" data-target="#myModal3"><img src="{{asset('/images/b3.jpg')}}" alt="blog image" class="img-responsive" /></a>

        </div>
        <div class="blog-box">
            <div class="blog-txt">
                <h3><a href="#" data-toggle="modal" data-target="#myModal4">Lorem Ipsum </a></h3>
                <p>Lorem ipsum is simply dummy text of the printing and typesetting industry. Lorem ip sum has been the industry's standard text ever.
                    Lorem ipsum is simply dummy text.</p>
                <!-- Trigger the modal with a button -->
                <a href="#" data-toggle="modal" data-target="#myModal4">Know More &raquo; </a>
                <!-- Modal -->
                <!-- bootstrap-pop-up -->
            ...
            <a href="#" data-toggle="modal" data-target="#myModal4"><img src="{{asset('/images/b4.jpg')}}" alt="blog image" class="img-responsive" /></a>
...
<div class="agileits-w3layouts">
    <div class="container">
        <p>© 2017 Edumate. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts</a></p>
    </div>
</div>
<!-- //copyright -->
